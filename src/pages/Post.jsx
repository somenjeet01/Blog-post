...
export default function Post() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen py-12 bg-gradient-to-bl from-blue-50 via-white to-blue-50 flex items-center justify-center">
  ...
  return post ? (
    <>
      ...
      <LoadingOverlay show={deleting} message="Deleting post..." />
